...
def pauli_polynomial_dynamic_ordering_treem(pp: PauliPolynomial, topo: Topology, tree, print_order=None, debug=False, random_sel=False):
    ...
    while removed_gadgets_num < num_gadgets:
        ...
        debug and print('-------Next gadget options:', next_options)
        ...
        for gadget in next_options:
            ...
            gate_sequence = []
            score_sum = (0,0)
            debug and print('-------Evaluating gadget:', gadget, 'num legs:', num_legs)
            while num_legs > 1:
                ...
                debug and print('-------Next edge:', edge, 'gates:', gates, 'gadget', gadget, 'score:', score)
...
def update_pauligraph(general_data, gadget_index, qubit1, qubit2, pauli1, pauli2):
    ...
    if pauligraph_degrees[gadget_index,qubit1] == 0 and pauligraph_degrees[gadget_index,qubit2] == 0 and pauli1 != 0b00 and pauli2 != 0b00:
        # Rare case that one leg gadget turn to two leg gadget
        add_connection(general_data, gadget_index, qubit1, qubit2)
        last_edge[gadget_index,qubit1] = qubit2
        last_edge[gadget_index,qubit2] = qubit1
